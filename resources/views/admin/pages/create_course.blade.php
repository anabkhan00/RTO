...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form method="POST" action="{{ route('admin.courses.store') }}" class="space-y-6" data-client-validate="course" novalidate>
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="code" value="{{ old('code') }}" placeholder="Enter Course Code"
                        required
                ...
                <div>
                    ...
                    <input type="text" name="credit_hours" value="{{ old('credit_hours') }}"
            ...
            <div class="bg-gray-50 rounded-lg p-6">
                ...
                @if ($checklists->isEmpty())
                    <div class="text-sm text-red-600 bg-red-50 p-4 rounded-lg">
                        ...
                        <a href="{{ route('admin.document-checklist') }}" class="text-blue-600 font-medium underline ml-1">
                            Click here to add document checklist
                        </a>
                    </div>
                @else
