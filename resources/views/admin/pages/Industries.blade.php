          ...
          <table class="min-w-full border-collapse w-full">
              ...
              <tbody class="">
                  <tr class="border-b font-medium text-xs hover:bg-gray-50">
                      <td class="p-3 whitespace-nowrap"> Ozcare - Ipswich</td>
                      <td class="p-3 whitespace-nowrap">offre St, Booval QLD 4304,
                          Australia</td>
                      <td class="p-3 whitespace-nowrap">61800692273</td>
                      <td class="p-3 whitespace-nowrap"> info@ozcareipswich.com</td>
              ...
              <form class="space-y-4">
                  <div class="flex flex-wrap -mx-3">
                      ...
                      <div class="w-full  p-3">
                          <label class="block text-sm font-medium text-brand">Industry Name <span
                                  class="text-red-500">*</span></label>
                          <input type="email" placeholder="Industry Name..."
                      ...
                      <div class="w-full md:w-1/2 lg:w-1/2 p-3">
                          <label class="block text-sm font-medium brand"> Address <span
                                  class="text-red-500">*</span></label>
                      ...
                      <!-- Contact -->
                      <div class="w-full md:w-1/2 lg:w-1/2 p-3">
                          <label class="block text-sm font-medium brand"> Phone <span
                                  class="text-red-500">*</span></label>
