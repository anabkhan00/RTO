...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow overflow-x-auto">
        <table id="rtoTable" class="min-w-full border-collapse w-full">
            <thead>
                <tr class="text-left text-brand font-normal text-sm border-b">
                    ...
                    <th class="p-3 whitespace-nowrap">Phone No</th>
                    <th class="p-3 whitespace-nowrap">CPN</th>
                    <th class="p-3 whitespace-nowrap">Website</th>
                    <th class="p-3 whitespace-nowrap">Onboard Date</th>
