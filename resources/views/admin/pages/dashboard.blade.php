          ...
          <div class="w-full flex flex-wrap">
                  ...
                  <div class="bg-white shadow-md  rounded-md p-4">
                      ...
                      <div class="w-full mt-3">
                          ...
                          <p class="flex items-center font-medium text-brand text-xs mt-2"><img
                                  src="{{ asset('assets/images/beeg.svg') }}" class="w-3 me-3">Full Time and Part time
                              Available</p>
                      </div>
                      <div class="w-full mt-3">
                          <button type="button"
              ...
              <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 p-3">
                  <div class="bg-white shadow-md  rounded-md p-4">
                      ...
                      <div class="w-full mt-3">
                          <p class="flex items-center font-medium text-brand text-xs"><img
                                  src="{{ asset('assets/images/location.svg') }}" class="w-3 me-3">Newcastle, Australia</p>
                          <p class="flex items-center font-medium text-brand text-xs mt-2"><img
                                  src="{{ asset('assets/images/beeg.svg') }}" class="w-3 me-3">Full Time and Part time
                              Available</p>
                      </div>
          ...
          <div class="w-full p-3">
              ...
              <div class="bg-white rounded-lg shadow overflow-x-auto">
                 ...
                 this.previousElementSibling.classList.toggle('bg-red-500', this.value === 'Rejected');">
                              ...
                              <td class="p-3 text-red-500 cursor-pointer whitespace-nowrap"><i
