        ...
        <div>
            ...
            <nav class="mt-2 space-y-1 px-6">
                <a href="{{ route('student.dashboard') }}"
                    class="flex items-center px-6 py-2 font-medium text-sm transition {{ request()->routeIs('student.dashboard') ? 'bg-brand rounded-lg text-white' : '' }}">
                    Dashboard
                </a>

                <a href="{{ route('student.placements') }}"
                    class="flex items-center px-6 py-2 font-medium text-sm transition {{ request()->routeIs('student.placements') ? 'bg-brand rounded-lg text-white' : '' }}">
                    My Placements
                </a>

                <a href="{{ route('student.documents') }}"
                    class="flex items-center px-6 py-2 font-medium text-sm transition {{ request()->routeIs('student.documents') ? 'bg-brand rounded-lg text-white' : '' }}">
                    Documents
                </a>
